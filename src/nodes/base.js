...
(function(global) {
	...
	*/
    ...
    function ConstantBoolean() {
        ...
        this.widget = this.addWidget("toggle","值",true,"value");
        this.serialize_widgets = true;
        this.widgets_up = true;
        this.size = [140, 30];
    }

    ConstantBoolean.title = "常量布尔型";
    ...
    function ConstantString() {
        ...
        this.widget = this.addWidget("text","值","","value");  //link to property value
        this.widgets_up = true;
        this.size = [180, 30];
    }

    ConstantString.title = "常量字符";
    ...
    ConstantFile.title = "文件常量";
    ConstantFile.desc = "从指定url抓取文件";
